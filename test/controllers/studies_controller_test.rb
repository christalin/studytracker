...
class StudiesControllerTest < ActionController::TestCase
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post :create, study: { principal_investigator: @study.principal_investigator, status: @study.status, title: @study.title }
    end
  ...
  test "should update study" do
    patch :update, id: @study, study: { principal_investigator: @study.principal_investigator, status: @study.status, title: @study.title }
    assert_redirected_to study_path(assigns(:study))
  end
